...
* adding as many changes as possible from most recent gitlab pull of skeleton to the currently used ve ([40e5a99](https://github.com/jsmorris2/skeleton/commit/40e5a99))
* changed package location to npm username ([b390f2f](https://github.com/jsmorris2/skeleton/commit/b390f2f))
* changed package metadata to phelpsm1 github account. ([36867c2](https://github.com/jsmorris2/skeleton/commit/36867c2))
* chore: add ability to perform unit tests ([15032d5](https://github.com/jsmorris2/skeleton/commit/15032d5))
* chore: add command to delete remote of branch ([5525893](https://github.com/jsmorris2/skeleton/commit/5525893))
* chore: add CONTRIBUTING ([9f4c7fa](https://github.com/jsmorris2/skeleton/commit/9f4c7fa))
* chore: bump version ([d5ae05f](https://github.com/jsmorris2/skeleton/commit/d5ae05f))
* chore: update changelog ([b40b71e](https://github.com/jsmorris2/skeleton/commit/b40b71e))
* chore: upgrade capitalize ([3930189](https://github.com/jsmorris2/skeleton/commit/3930189))
* chore: upgrade deps ([bad173f](https://github.com/jsmorris2/skeleton/commit/bad173f))
* chore: upgrade eslint ([5b9fa0b](https://github.com/jsmorris2/skeleton/commit/5b9fa0b))
* chore: upgrade eslint ([2299ab7](https://github.com/jsmorris2/skeleton/commit/2299ab7))
* chore: upgrade eslint ([a7a1b0c](https://github.com/jsmorris2/skeleton/commit/a7a1b0c))
* chore: upgrade eslint ([9ba5a7e](https://github.com/jsmorris2/skeleton/commit/9ba5a7e))
* chore: upgrade eslint ([f6fbfe9](https://github.com/jsmorris2/skeleton/commit/f6fbfe9))
* chore: upgrade eslint libs ([3546e7a](https://github.com/jsmorris2/skeleton/commit/3546e7a))
* chore: upgrade find-process ([5b5f8a6](https://github.com/jsmorris2/skeleton/commit/5b5f8a6))
* chore: upgrade find-process ([46d5311](https://github.com/jsmorris2/skeleton/commit/46d5311))
* chore: upgrade fs-extra ([6a10d99](https://github.com/jsmorris2/skeleton/commit/6a10d99))
* chore: upgrade glob ([162278e](https://github.com/jsmorris2/skeleton/commit/162278e))
* chore: upgrade glob ([26fd5b2](https://github.com/jsmorris2/skeleton/commit/26fd5b2))
* chore: upgrade got ([0d76e26](https://github.com/jsmorris2/skeleton/commit/0d76e26))
* chore: upgrade got ([4a9f713](https://github.com/jsmorris2/skeleton/commit/4a9f713))
* chore: upgrade got ([e0c33eb](https://github.com/jsmorris2/skeleton/commit/e0c33eb))
* chore: upgrade gulp-msbuild ([dbee638](https://github.com/jsmorris2/skeleton/commit/dbee638))
* chore: upgrade juice ([9d7baba](https://github.com/jsmorris2/skeleton/commit/9d7baba))
* chore: upgrade juice ([68d3cbd](https://github.com/jsmorris2/skeleton/commit/68d3cbd))
* chore: upgrade mocha ([f5bf183](https://github.com/jsmorris2/skeleton/commit/f5bf183))
* chore: upgrade mssql ([05a81f5](https://github.com/jsmorris2/skeleton/commit/05a81f5))
* chore: upgrade mssql ([9691d9f](https://github.com/jsmorris2/skeleton/commit/9691d9f))
* chore: upgrade mssql ([4693484](https://github.com/jsmorris2/skeleton/commit/4693484))
* chore: upgrade mssql ([83e5f33](https://github.com/jsmorris2/skeleton/commit/83e5f33))
* chore: upgrade nodemailer ([77982bd](https://github.com/jsmorris2/skeleton/commit/77982bd))
* chore: upgrade nodemailer ([b4c72af](https://github.com/jsmorris2/skeleton/commit/b4c72af))
* chore: upgrade nodemailer ([5f05252](https://github.com/jsmorris2/skeleton/commit/5f05252))
* chore: upgrade nodemailer ([d1ee28f](https://github.com/jsmorris2/skeleton/commit/d1ee28f))
* chore: upgrade nodemailer ([4f12a8e](https://github.com/jsmorris2/skeleton/commit/4f12a8e))
* chore: upgrade pug ([42273a2](https://github.com/jsmorris2/skeleton/commit/42273a2))
...
* chore(dep): upgrade ansi-colors ([64ff588](https://github.com/jsmorris2/skeleton/commit/64ff588))
* chore(dep): upgrade eslint ([ad8ff75](https://github.com/jsmorris2/skeleton/commit/ad8ff75))
* chore(dep): upgrade eslint and related libs ([235cb97](https://github.com/jsmorris2/skeleton/commit/235cb97))
* chore(dep): upgrade eslint and related libs ([381f078](https://github.com/jsmorris2/skeleton/commit/381f078))
* chore(dep): upgrade fancy-log ([d4b0158](https://github.com/jsmorris2/skeleton/commit/d4b0158))
* chore(dep): upgrade fs-extra ([ddfd281](https://github.com/jsmorris2/skeleton/commit/ddfd281))
* chore(dep): upgrade glob ([7a8f278](https://github.com/jsmorris2/skeleton/commit/7a8f278))
* chore(dep): upgrade got ([1ce00d9](https://github.com/jsmorris2/skeleton/commit/1ce00d9))
* chore(dep): upgrade gulp-msbuild ([f23a180](https://github.com/jsmorris2/skeleton/commit/f23a180))
* chore(dep): upgrade juice ([ac135b4](https://github.com/jsmorris2/skeleton/commit/ac135b4))
* chore(dep): upgrade log4js ([b0513ae](https://github.com/jsmorris2/skeleton/commit/b0513ae))
* chore(dep): upgrade mocha and chai ([ad3c68e](https://github.com/jsmorris2/skeleton/commit/ad3c68e))
* chore(dep): upgrade moment ([5141114](https://github.com/jsmorris2/skeleton/commit/5141114))
* chore(dep): upgrade mssql ([296049f](https://github.com/jsmorris2/skeleton/commit/296049f))
* chore(dep): upgrade mssql ([bff382e](https://github.com/jsmorris2/skeleton/commit/bff382e))
* chore(dep): upgrade nodemailer ([6f6c227](https://github.com/jsmorris2/skeleton/commit/6f6c227))
* chore(dep): upgrade plugin-error ([0d894ba](https://github.com/jsmorris2/skeleton/commit/0d894ba))
* chore(dep): upgrade shelljs ([f3ce022](https://github.com/jsmorris2/skeleton/commit/f3ce022))
* chore(nvm): using nvm ([42ea4ab](https://github.com/jsmorris2/skeleton/commit/42ea4ab))
* fix: add better error message when pillar is not defined ([3c8470b](https://github.com/jsmorris2/skeleton/commit/3c8470b))
* fix: handle edge cases when adding throttlePolicy ([b6ad4cc](https://github.com/jsmorris2/skeleton/commit/b6ad4cc))
