...
gulp.task('app:down', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to bring app down in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:up', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to bring app up in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:offline', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to set app offline in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:online', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to set app online in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:recycle', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to recycle app in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:link', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to link app in ${process.env.target} environment`, help)
    return
  }
...
gulp.task('app:status', () => {
  ...
  if (env.is('local')) {
    util.log(`No need to check status of app in ${process.env.target} environment`, help)
    return
  }
